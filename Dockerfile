...
# System-Dependencies für Playwright und zusätzliche fehlende Libraries
RUN apt-get update && apt-get install -y \
    ...
    libsndfile1 libpulse0 \
    libatomic1 libxslt1.1 libwoff2-1 libvpx7 libevent-2.1-7 \
    libgstreamer-plugins-base1.0-0 libflite1 libwebpdemux2 libavif15 libharfbuzz-icu0 \
    libwebpmux3 libhyphen0 libx264-163 \
